  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Guest Notice */}
        {isGuest && (
          <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6 mb-8 animate-fade-in-up animate-delay-200">
        ...
        {/* Quick Stats */}
        {!isGuest && (
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 animate-fade-in-up animate-delay-400">
        ...
        {modelsError && (
          <div className="bg-red-50 border border-red-200 rounded-2xl p-6 mb-8 animate-fade-in animate-delay-500">
            <div className="flex items-center space-x-3">
        ...
        {isGuest || profile?.subscription_status === 'free' ? (
          <div className="bg-gradient-to-r from-[#812dea] to-[#4ea6fd] rounded-2xl p-8 text-white text-center">
            {/* Error Message */}
            {upgradeError && (
              <div className="bg-red-500/20 border border-red-300/30 rounded-lg p-4 mb-6 opacity-1 animate-fade-in">
